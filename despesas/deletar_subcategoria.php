	...
	<div class="remodal-bg">
		<div class="remodal" data-remodal-id="modaldel">
		    ...
		    <?php
				...
				echo "Empresa : <b>".$aux_query['descricao']."<b><br>";


				echo "<a href=\"dados_subdeletados.php?id=".$aux_query['id']."\" class=\"btn btn-large btn-success\"> Sim</a>&nbsp;&nbsp;";
				echo "<a href=\"../subcategoria.php\" class=\"btn btn-large btn-warning\"> Não</a>";
